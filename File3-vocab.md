# English File Intermediate - File 3 - Selected Vocabulary
(Excluding Practical English & Social English)

| İngilizce Kelime             | Türkçe Karşılığı                           | Örnek Cümle (Example Sentence from PDF)                                     |
| :--------------------------- | :----------------------------------------- | :-------------------------------------------------------------------------- |
| **Transport Vocabulary** | **Ulaşım Kelimeleri** |                                                                             |
...
| **Dependent Prepositions** | **Edat Alan Kelimeler** |                                                                             |
...
| **More words and phrases** | **Diğer Kelimeler ve İfadeler** |                                                                             |
| ahead of                     | -nın önünde                                | She stayed ahead of the other runner for the whole race.                    |
| argue                        | Tartışmak, iddia etmek                     | Scientists argue that our sense of humour has a purpose.                    |
| crash into                   | -e çarpmak                                 | Be careful not to crash into that car in front!                             |
| discover                     | Keşfetmek, bulmak                          | Scientists discovered a gene that helps us communicate.                     |
| find                         | Bulmak, keşfetmek                          | An academic study found some interesting differences.                       |
| generally                    | Genellikle                                 | I generally drink tea in the mornings.                                      |
| get stuck                    | Sıkışıp kalmak (trafikte)                  | Do you often get stuck in traffic in the morning?                           |
| get worse                    | Kötüleşmek, daha kötüye gitmek             | The traffic's getting worse! We're going to be late.                        |
| in general                   | Genel olarak                               | In general, the traffic is bad between 8am and 9am.                         |
| likely                       | Muhtemel, olası                            | That makes it more likely you will lose control of the car.                 |
| on the whole                 | Genel olarak, genellikle                   | On the whole, I think the speed limits are sensible.                        |
| prove                        | Kanıtlamak, ispatlamak                     | A new study proves that their argument is correct.                          |
| show                         | Göstermek                                  | The research shows that multitasking doesn't always work.                   |
| tend                         | Eğiliminde olmak                           | People tend to get distracted when they drive and talk.                     |
| turn around                  | Geri dönmek, arkasını dönmek               | We're going the wrong way. We have to turn around.                          |
| turn out                     | Ortaya çıkmak, anlaşılmak                  | It turns out that the cliché is true.                                       |
| turn red                     | Kırmızıya dönmek (ışık)                    | The traffic lights will turn red very soon. Please stop.                    |
| usually                      | Genellikle                                 | I usually get to work by 8.30 a.m.                                          |
